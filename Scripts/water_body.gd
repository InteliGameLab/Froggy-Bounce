...
@onready var water_spring = preload("res://Scenes/obstacles/water.tscn") 


@export var depth = 1000
var target_position = global_position.y
var bottom = target_position + depth 
